...
>**🚀 <u>Action</u>**
>Click the **Overview** Tab and select the alert (under Probable cause alerts) that has a reference to mysql. Then, in the topology map for that alert, right-click on the `mysql` resource and select `Open in Topology viewer`
>
